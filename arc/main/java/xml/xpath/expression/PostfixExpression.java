...
public class PostfixExpression implements Expression {
    ...
    private static final String LITERAL_PATTERN = "(" + NUMERIC_LITERAL + "|" + STRING_LITERAL_PATTERN + ")";
    private static final String VARIABLE_NAME_PATTERN = NODE_NAME_PATTERN;
    ...
    private static final String FUNCTION_ITEM_PATTERN = NODE_NAME_PATTERN;
